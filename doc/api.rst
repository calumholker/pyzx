...
Circuit extraction, matrices over Z2 and phase polynomial synthesis
-------------------------------------------------------------------
...
.. automodule:: pyzx.simplify
   ...
   The following functions implement a single rewrite frum rules_ using the helper function :func:`~pyzx.simplify.simp`
